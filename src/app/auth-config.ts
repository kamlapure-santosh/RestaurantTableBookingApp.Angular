...
export const b2cPolicies = {
  ...
  authorities: {
    signUpSignIn: {
      authority:
        'https://tablebookingorg.b2clogin.com/tablebookingorg.onmicrosoft.com/B2C_1_susi',
    },
    resetPassword: {
      authority:
        'https://v.b2clogin.com/tablebookingorg.onmicrosoft.com/B2C_1_password_reset',
    },
    editProfile: {
      authority:
        'https://tablebookingorg.b2clogin.com/tablebookingorg.onmicrosoft.com/B2C_1_profile_edit',
    },
  },
  authorityDomain: 'tablebookingorg.b2clogin.com',
};
